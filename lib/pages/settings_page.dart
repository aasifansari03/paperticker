      ...
      body: new ListView(
        children: <Widget>[
          new Container(
            ...
            child:
                new Text("Theme", style: Theme.of(context).textTheme.bodyText2),
          ),
          new Container(
          ...
          new Container(
            ...
            child: new ListTile(
              ...
              onTap: () => _launchUrl("https://www.growmonks.in"),
            ),
          ),
          new Container(
            color: Theme.of(context).cardColor,
            child: new ListTile(
              title: new Text("Version 1.0.0 (1)"),
          ...
          new Container(
            ...
            child: new ListTile(
              ...
              subtitle: new Text("www.growmonks.in"),
              leading: new Icon(
                Icons.favorite,
                color: Colors.red,
              ),
